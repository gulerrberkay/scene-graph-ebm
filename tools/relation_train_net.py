...
def main():
    ...
    #path_to_configg_file = "configs/e2e_relation_R_101_FPN_1x.yaml"         # Added this one!
    path_to_configg_file = "configs/e2e_relation_X_101_32_8_FPN_1x.yaml"
    cfg.merge_from_file(path_to_configg_file)  #cfg.merge_from_file(args.config_file)
    ...
    logger.info("Loaded configuration file {}".format(path_to_configg_file))   #    logger.info("Loaded configuration file {}".format(args.config_file))
    with open(path_to_configg_file, "r") as cf:   #     with open(args.config_file, "r") as cf:
        config_str = "\n" + cf.read()
