...
_C.INPUT.PIXEL_MEAN = [102.9801, 115.9465, 122.7717]   # BGR format
#_C.INPUT.PIXEL_MEAN = [122.7717, 115.9465, 102.9801]   # RGB format
...
_C.MODEL.RESNETS.TRANS_FUNC = "BottleneckWithFixedBatchNorm"  #BottleneckWithFixedBatchNorm
# ResNet's stem function (conv1 and pool1)
_C.MODEL.RESNETS.STEM_FUNC = "StemWithFixedBatchNorm"   #StemWithFixedBatchNorm
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "/users/students/r0879687/amager/vg/output"
_C.GLOVE_DIR = "/users/students/r0879687/amager/vg/glove"

_C.PATHS_CATALOG = os.path.join(os.path.dirname(__file__), "paths_catalog.py")
#_C.PATHS_DATA = os.path.join(os.path.dirname(__file__), "../data/datasets")
_C.PATHS_DATA = "/users/students/r0879687/amager/vg/VG_100K"
# ---------------------------------------------------------------------------- #
# Precision options
# ---------------------------------------------------------------------------- #
